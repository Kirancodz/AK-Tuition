...
<body background="assets/images/coverpage4.jpg">
            ...
            <div class="navbar-collapse nav-main-collapse collapse pull-right">
                <nav class="nav-main mega-menu">
                    <ul class="nav nav-pills nav-main scroll-menu" id="topMain">
                        <li><a href="page-student-details.php?id=<?php echo htmlspecialchars($id); ?>">Student Details</a></li>
                        <li><a href="page-student-subject-reg.php?id=<?php echo htmlspecialchars($id); ?>">Subject Registration</a></li>
                        <li class="active"><a href="page-student-timetable.php?id=<?php echo htmlspecialchars($id); ?>">Timetable</a></li>
    ...
    <div id="wrapper">
        <!-- Timetable Section -->
        <section id="timetable" class="padding60">
            ...
            <div class="container">
                <table id="tablestyle" class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        // Ensure ID is properly sanitized to prevent SQL injection
                        $id = mysqli_real_escape_string($db, $id);

                        // Fetch timetable information
                        $sql = "SELECT L.subject_code, T.timetable_day, T.timetable_session 
                                FROM learn L 
                                JOIN timetable T ON L.subject_code = T.subject_code 
                                WHERE L.stu_id = '$id'";
                        ...
                        if (!$result) {
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                echo '<tr>
                                        ...
                                        <td>' . htmlspecialchars($row['timetable_day']) . '</td>
                                        <td>' . htmlspecialchars($row['timetable_session']) . '</td>
                                      </tr>';
                            }
                        }
                        ?>
