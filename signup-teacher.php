...
<!--[if gt IE 9]><!--> <html> <!--<![endif]-->
    <head>
        ...
        <script type="text/javascript">
            function go(){
                alert("Email will be sent to you if your application details are approved by us. Thank you.");
            }
        </script>
    </head>
    <body>
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="center-box">
                        ...
                        $sql = "SELECT * FROM subject"; // SQL query to select all subjects
                        $result = mysqli_query($db, $sql); // Execute the query and store the result
                        ?>
